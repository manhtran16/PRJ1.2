...
package controller.admin.admindashboar;
...
public class admindashboard extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        // Lấy dữ liệu dashboard từ service hoặc DAO
        ...
        // DEBUG===================
        System.out.println(dashboardService.getTotalOrders());
        System.out.println(dashboardService.getTotalProducts());
        System.out.println(dashboardService.getTotalCustomers());
        System.out.println((long) dashboardService.getTotalRevenue());
