...
public class ProductDao extends DBContext {
     ...
     * "SELECT h.SpecProduct, h.SpecProductValue, s.SpecName, h.SpecID FROM Has h JOIN Specifications s ON h.SpecID = s.SpecID WHERE h.ProductID = ?"
     * ;
     * private final String GET_AVG_PRODUCCT_RATE
     * = "SELECT AVG(CAST(Rate AS FLOAT)) AS AvgRate FROM "
     * + "Rating WHERE ProductID = ?";
     * private final String GET_TOTAL_SOLD =
     ...
     * // Insert main product
     * String sql =
     * "INSERT INTO Product (ProductName, ProductQuantity, Description, Price, BrandID) VALUES (?, ?, ?, ?, ?)"
     * ;
     ...
     * }
     * 
     * private void createProductSpec(int productId, SpecProduct spec) throws
     * SQLException {
     * String sql =
     * "INSERT INTO Has (SpecProduct, SpecProductValue, SpecID, ProductID) VALUES (?, ?, ?, ?)"
     * ;
     * try (PreparedStatement stm = c.prepareStatement(sql)) {
     ...
     * }
     * 
     * private void createProductImage(int productId, String url) throws
     * SQLException {
     ...
     * 
     * /**
     * Get all product ưith brand information
     */
    public java.util.List<Product> getAllProducts() {
        ...
        try {
            ...
            java.sql.PreparedStatement stm = c.prepareStatement(sql);
