                    ...
                    <div class="mask" style="background-color: rgba(0, 0, 0, 0.6)">
                        <div class="d-flex justify-content-center align-items-center h-100">
                            <div class="text-white">
                                <h1 class="mb-3" style="color: red">SALE CUỐI THÁNG</h1>
                                    ...
                                    <div class="card">
                                        <div class="bg-image hover-overlay" data-mdb-ripple-init data-mdb-ripple-color="light">
                                            <c:choose>
                                                <c:when test="${not empty product.variants and not empty product.variants[0].images}">
                                                    <img src="${product.variants[0].images[0].url}" class="img-fluid"/>
                                                </c:when>
                                                <c:otherwise>
                                                    <img src="https://via.placeholder.com/300x200?text=No+Image" class="img-fluid"/>
                                                </c:otherwise>
                                            </c:choose>
                                            <a href="displayPro.jsp?productId=${product.productID}">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <c:if test="${not empty product.variants}">
                                                <h6>${product.variants[0].price} đ</h6>
                                            </c:if>                            <p class="card-text">${product.description}</p>
                            <c:choose>
                                <c:when test="${not empty sessionScope.user}">
                                    <c:if test="${not empty product.variants}">
                                        <a href="cart?action=add&variantId=${product.variants[0].variantID}&quantity=1" class="btn btn-primary" data-mdb-ripple-init>
                                            Thêm vào giỏ
                                        </a>
                                    </c:if>
